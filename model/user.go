...
type User struct {
	...
	ZipCode     int    `gorm:"column:zip_code;type:integer;not null"`
	StreetName  string `gorm:"column:street_name;type:text;not null"`
	HouseNumber int    `gorm:"column:house_number;type:integer;not null"`
